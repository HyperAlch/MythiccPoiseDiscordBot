...
impl VoiceEvent {
    async fn execute_user_joined_log(
    ...
    async fn execute_user_left_log(
        channel_id: &ChannelId,
        ctx: &serenity::Context,
        data: &Data,
        user_id: UserId,
    ...
    async fn execute_user_moved_log(
    ...
    pub async fn post_to_log_channel(
        ...
        match self {
            Self::UserJoinedChannel(channel_id, user_id) => {
                Self::execute_user_joined_log(channel_id, ctx, data, *user_id).await?;
            }
            Self::UserLeftChannel(channel_id, user_id) => {
                Self::execute_user_left_log(channel_id, ctx, data, *user_id).await?;
            }
            Self::UserMovedChannel(old_channel_id, new_channel_id, user_id) => {
                Self::execute_user_moved_log(old_channel_id, new_channel_id, ctx, data, *user_id)
                    .await?;
            }
            Self::Unknown => (),
        }
